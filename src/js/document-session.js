(function () {
  ...
  function createDocumentSession(options) {
    ...
    return {
      ...
      remoteChanged: Boolean(options.remoteChanged),
      remoteMissing: Boolean(options.remoteMissing),
      ...
      assetErrors: options.assetErrors || {},
      assetLoadGeneration: options.assetLoadGeneration || 0,
      assetObjectUrls: options.assetObjectUrls || {},
      assetObjectUrlPromises: options.assetObjectUrlPromises || {},
