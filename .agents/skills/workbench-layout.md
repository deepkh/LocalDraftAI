...
- `src/js/activity-bar.js` owns only active workbench view and sidebar-visibility coordination. It routes Files, Search, and Related to `workspace-sidebar.js`, AI visibility to `ai-assistant.js`, and Settings to the existing AI settings dialog.
