...
- Opening a workspace file or selecting its tab should expand its parent folders and scroll the active Explorer row into view. Preserve Search/Related as the active view and defer the scroll until Files is visible.
