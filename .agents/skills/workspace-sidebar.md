...
- Keep the left sidebar compatible with the permanent layout: expanded/minimized/hidden modes on the left, center editor protected from becoming unusably narrow, and right AI review panel width clamping accounted for when both sides are visible.
