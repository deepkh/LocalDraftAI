...
- Represent the active workspace with a provider-aware descriptor. `workspace-store.js` builds eager trees by calling provider directory methods; `workspace-operations.js` validates names and dispatches mutations to the active provider.
