...
- Workspace RPCs open, close, and inspect a canonical SFTP workspace root. Filesystem RPCs list, stat, read, conditionally write, create, rename, duplicate, and search through workspace IDs and relative POSIX paths.
